<div class="left">
	...
	<div style="background-color: #FFF; background-color: rgba(255, 255, 255, 0.5); border-top: 1px solid #AAA; padding: 10px; margin-bottom: 10px; padding-bottom: 1px; background-image: url('<?php echo url::base(); ?>images/comment_divide.png'); background-repeat: repeat-x; background-position: bottom;">
		...
		?>
			<div style="clear: both; margin-bottom: 10px; overflow: hidden; border-bottom: 1px dotted #AAA; position: relative;">
				...
				<div style="float: left; margin-left: 5px; width: 470px;">
					<p style="color: #555;">
