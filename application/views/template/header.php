...
<?php } ?>
        ...
        <div id="container">
            ...
            <ul id="text-navigation">
				...
				<li style="float: right;"><?php if ($this->logged_in == TRUE) { ?>Hey <?php echo $this->username; ?> (<a href="<?php echo url::base(); ?>dashboard/">Dashboard</a>) <a href="<?php echo url::base(); ?>users/logout/"><img src="<?php echo url::base(); ?>images/icons/logout.png" alt="Logout" title="Logout" /></a><?php } else {?><a href="<?php echo url::base(); ?>users/login/">Login/Register</a><?php } ?></li>
            </ul>
		</div>
