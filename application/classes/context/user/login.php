<?php
/**
 * Eadrax application/classes/context/user/login.php
 *
 * @package   Context
 ...
 * @package Context
 */
class Context_User_Login extends Context_Core
{
    /**
     * Guest role
     * @var Guest
    ...
    {
        $this->guest = new Context_User_Login_Guest($model_user);
        $repository = new Context_User_Login_Repository;
