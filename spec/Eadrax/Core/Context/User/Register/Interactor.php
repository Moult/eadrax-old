...
{
    /**
     * @param Eadrax\Core\Context\User\Register\Guest $guest
     * @param Eadrax\Core\Context\User\Login\Interactor $user_login
     */
    ...
    {
        $this->shouldHaveType('Eadrax\Core\Context\User\Register\Interactor');
    }
